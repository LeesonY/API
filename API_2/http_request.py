...
if __name__ == '__main__':
    ...
    # params = {'mobilephone':'18574379913','pwd':'123456'}
    # resp = http_request2.request('POST', 'http://test.lemonban.com/futureloan/mvc/api/member/login',
    #                                 data=params)
    # params = {'mobilephone':'18574379913','amount':'1000'}
    # resp2 = http_request2.request('POST','http://test.lemonban.com/futureloan/mvc/api/member/recharge',
    #                              data=params)
    #
    # print(resp2.status_code)
    # print(resp2.text)
